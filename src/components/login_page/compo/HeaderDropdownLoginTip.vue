...
<template>
  <div class="login-panel-popover">
    ...
    <div class="login-tip-content">
      <div class="login-tip-content-item">
        <svg
          ...
          width="24"
          height="24"
          class="login-tip-content-item-icon"
          fill="currentColor"
        >
          <path
    ...
    <el-button @click="openGlobalLoginModal" class="login-btn">立即登录</el-button>
    <div class="register-tip">
      首次使用？ <span class="register-exper" @click="openGlobalLoginModal"> 点我注册 </span>
    </div>
  </div>
</template>
...
.login-tip-content.login-tip-content .login-tip-content-item-icon {
  width: 24px;
  height: 24px;
}
...
.login-panel-popover .register-tip {
  margin-top: 16px;
  text-align: center;
  letter-spacing: 0;
  font-size: 14px;
...
.login-panel-popover .register-exper {
  color: #00b5e5;
  cursor: pointer;
}
</style>
