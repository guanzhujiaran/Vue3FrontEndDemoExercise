 ...
 * @FilePath: \Vue3FrontEndDemoExercise\src\views\NotFoundView.vue
 * @Description: 404页面，当路由没有匹配到时展示，10秒后自动跳转到首页
-->
...
<template>
  <div class="not-found-content">
    <el-image :src="BiliImg.error.not_found" referrerpolicy="no-referrer"> </el-image>
