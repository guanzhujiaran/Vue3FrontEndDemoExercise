...
<template>
  <div class="side-bar" v-if="props">
    ...
    <div class="list">
      <router-link :to="{path:'/app/user-center/account_detail/account_name'.concat(account_info.info.account_name)}" v-for="account_info of props" :key="account_info.info.account_name" 
    ...
    <div class="setting item">
      <router-link to="/app/user-center/config" title="全局设置">
