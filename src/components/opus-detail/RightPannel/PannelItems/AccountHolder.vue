...
<template>
  <div class="message-list" ref="Message_box_show_div">
    <div class="message-list-content min_h_100">
      <div class="msg-more">
        <span class="no-more" style="display: none">没有更多消息了～</span><span class="loading" style="display: none">
        ...
        </span><span class="error" style="display: none">消息加载失败，<span class="btn">点击重新加载</span></span>
      </div>
      <SingleMessage class="msg-item not-me" v-for="item of MsgList" :key="item.msg_key" :session_msg="item" />
    </div>
  </div>
</template>
00
...
const MsgList = ref<Array<AccountMsgSessionModel>>([])
