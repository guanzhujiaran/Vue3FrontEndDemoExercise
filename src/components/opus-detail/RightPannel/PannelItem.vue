 ...
 * @LastEditTime: 2024-04-03 15:16:41
...
const account_detail = ref<TAccountDetail>({}) //TODO 通过api，使用传递过来的account_info发起ajax请求，获取到账号详情
</script>

<template>
  <Placeholder v-if="Object.keys(account_detail).length <= 1"></Placeholder>
  <AccountHolder v-else></AccountHolder>
</template>
